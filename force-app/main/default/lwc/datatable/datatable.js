...
export default class Datatable extends LightningElement {
    ...
    connectedCallback() {
        ...
        if (this.isConfigMode) { 
            ...
            console.log('from dataTable.js', this.consoleLogPrefix+"Config Mode Input columnAlignments:", this.columnAlignments);
        ...
        console.log('from the datatable.js' , this.consoleLogPrefix+'columnArray - ',this.columnArray);  
